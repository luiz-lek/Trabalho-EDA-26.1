...
#define PATH_METADATA_PERSON_TREE "../data/tree/person/metadata.dat"
#define PATH_METADATA_MOVIE_TREE "../data/tree/movie/metadata.dat"

#define PATH_INDEX_PERSON_TREE "../data/tree/person/index.dat"
#define PATH_INDEX_MOVIE_TREE "../data/tree/movie/index.dat"

#define PATH_DATA_PERSON_TREE "../data/tree/person/data.dat"
#define PATH_DATA_MOVIE_TREE "../data/tree/movie/data.dat"
...
#define PATH_HASH_MOVIE_TABLE "../data/hash/movie/table.dat"
#define PATH_HASH_MOVIE_DATA "../data/hash/movie/data.dat"

#define PATH_HASH_PERSON_TABLE "../data/hash/person/table.dat"
#define PATH_HASH_PERSON_DATA "../data/hash/person/data.dat"

#define PATH_RELATIONSHIPS_DATA "../data/tree/relationships.dat"
